...
public class EPaperRequestServiceTest {
	...
	public void test_save() throws Exception {
		...
		MockMultipartFile mockFile = new MockMultipartFile("file", file.getName(), "application/xml",
				getClass().getResourceAsStream("/correct.xml"));
	...
	@Test
	public void test_findAll_descendingTrue() throws NoRecordFoundException, InvalidSortValueException {
	...
	@Test
	public void test_findAll_descendingFalse() throws NoRecordFoundException, InvalidSortValueException {
		List<EPaperRequest> list = prepareListData();
		when(repo.findAll(any(Pageable.class))).thenReturn(new PageImpl<EPaperRequest>(list, PageRequest.of(0, 2), 2));
	...
	public void test_find_newspaperName_descendingFalse() throws InvalidFilterTypeException, NoRecordFoundException,
			NumberFormatException, InvalidSortValueException {
		List<EPaperRequest> list = prepareListData();
	...
	@Test
	public void test_find_height_descendingTrue()
			throws InvalidFilterTypeException, NoRecordFoundException, InvalidSortValueException {
		List<EPaperRequest> list = prepareListData();
		Collections.sort(list, (r1, r2) -> r2.getUploadTime().compareTo(r1.getUploadTime()));
		when(repo.findByHeight(anyInt(), any(Pageable.class))).thenReturn(list);
	...
	@Test
	public void test_find_dpi_descendingFalse()
			throws InvalidFilterTypeException, NoRecordFoundException, InvalidSortValueException {
		List<EPaperRequest> list = prepareListData();
	...
	@Test
	public void test_find_dpi_descendingTrue()
			throws InvalidFilterTypeException, NoRecordFoundException, InvalidSortValueException {
		List<EPaperRequest> list = prepareListData();
		Collections.sort(list, (r1, r2) -> r2.getUploadTime().compareTo(r1.getUploadTime()));
		when(repo.findByDpi(anyInt(), any(Pageable.class))).thenReturn(list);
	...
	@Test
	public void test_find_width_descendingFalse()
			throws InvalidFilterTypeException, NoRecordFoundException, InvalidSortValueException {
		List<EPaperRequest> list = prepareListData();
	...
	@Test
	public void test_find_width_descendingTrue()
			throws InvalidFilterTypeException, NoRecordFoundException, InvalidSortValueException {
		List<EPaperRequest> list = prepareListData();
		Collections.sort(list, (r1, r2) -> r2.getUploadTime().compareTo(r1.getUploadTime()));
		when(repo.findByWidth(anyInt(), any(Pageable.class))).thenReturn(list);
	...
	public void test_findAll_listEmpty_NoRecordFoundException() {
		when(repo.findAll(any(Pageable.class)))
				.thenReturn(new PageImpl<EPaperRequest>(new ArrayList<>(), PageRequest.of(0, 2), 2));
